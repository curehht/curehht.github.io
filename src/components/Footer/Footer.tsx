    ...
    <footer className='footer'>
      ...
      <section className='footer__section'>
        ...
        <ul className='communities'>
          ...
          <li><a
            href="https://www.facebook.com/groups/L.W.H.H.Tphotosvideos/">Living with HHT Read our stories & see our Photos & More.</a>
          </li>
      ...
      <section className='footer__section'>
        ...
        <h3 className="section__header">код</h3>
        <p>
          <a href="https://github.com/curehht/curehht.github.io">curehht.github.io</a>
        </p>
      </section>
    </footer>
  )
