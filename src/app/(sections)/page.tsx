  ...
  return (
    <div className="IndexPage">
      ...
      <article>
        ...
        <main>
          <h1>О болезни Рандю-Ослера</h1>
          <p>
            <em>Наследственное</em> заболевание сосудов, на разных участках кожи
            и слизистых оболочках губ, рта, во внутренних органах образуется
            кровотечения.
          </p>
          <p>
            Большинство больных не подозревают о своей болезни длительное время
            и остаются не диагностированными.
          </p>
          <p>
          ...
          <p>
            ...
            получить только одну копию изменённого (мутировавшего) гена от
            одного из родителей. Вот основные моменты, которые помогают понять,
            что это значит:
          </p>
          ...
          <ol>
            ...
            <li>
              ...
              геноме каждый ген представлен двумя копиями — одна от мамы и одна
              от папы. Для аутосомно-доминантного заболевания достаточно, чтобы
              одна из этих двух копий была изменённой, чтобы болезнь проявилась.
              В этом случае даже если другая копия гена нормальная, изменённая
              копия будет &ldquo;доминировать&rdquo; и приведет к развитию
              болезни.
            </li>
            <li>
              <strong>Вероятность передачи:</strong> Если один из родителей
              имеет аутосомно-доминантное заболевание, то у каждого ребёнка есть
              50% шанс унаследовать изменённый ген и тоже заболеть. Если же
              ребёнок не унаследует этот ген, он не будет болеть и не передаст
              заболевание дальше.
            </li>
          </ol>
        </main>
